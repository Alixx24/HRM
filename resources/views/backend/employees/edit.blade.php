...
<form action="{{ url('admin/employees/edit', $fetchData->id) }}" method="post" accept="" enctype="">
  ...
  <div class="form-group">
    ...
    <input name="name" type="text" class="form-control" id="exampleInputEmail1" value="{{ $fetchData->name }}"
  ...
  <div class="form-group">
    ...
    <input name="last_name" type="text" class="form-control" id="exampleInputEmail1" value="{{ $fetchData->last_name }}"
      aria-describedby="emailHelp">
    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
  </div>
  ...
  <div class="form-group">
    ...
    <input name="hire_date" type="date" class="form-control" value="{{ $fetchData->hire_date }}"
      aria-describedby="emailHelp">
    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <select class="form-control" name="job_id" value="job_id" id="">
  ...
  <div class="form-group">
    ...
    <input name="salary" type="number" class="form-control" value="{{ $fetchData->salary }}" id="exampleInputEmail1"
      aria-describedby="emailHelp">
  </div>

  <div class="form-group">
    <label for="exampleInputEmail1">commision_pct</label>
    <input name="commision_pct" value="commision_pct" type="text" class="form-control" id="exampleInputEmail1"
      aria-describedby="emailHelp">
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <select class="form-control" value="manager_id" name="manager_id" id="">
        <option value="">select job</option>
        <option value="1">web dec</option>
        <option value="2">pdf dev</option>
